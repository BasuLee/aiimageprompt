...
const HEADINGS: Record<SupportedLanguage, {
  ...
  en: {
    ...
    subtitle: "Explore stunning visuals generated by Nano Banana and GPT-4o, featuring trending examples and creative keywords.",
    filtersTitle: "Filter the dataset",
    galleryTitle: "Featured prompt collections",
  },
  zh: {
    title: "AI 提示词画廊",
  ...
  return (
    <div className="space-y-10">
      <header className="space-y-4 text-center md:text-left">
        <h1 className="text-4xl font-semibold tracking-wide text-cyan-100 md:text-5xl">{headings.title}</h1>
        <p className="text-base leading-7 text-slate-200 md:max-w-3xl">{headings.subtitle}</p>
      </header>

      <section
        aria-labelledby="filters-heading"
        className="relative rounded-2xl border border-purple-500/30 bg-gradient-to-br from-slate-900/80 via-slate-900/70 to-purple-900/30 p-4 md:p-6 shadow-lg shadow-purple-500/10 backdrop-blur-sm overflow-hidden"
      >
        {/* 额外的霓虹装饰 */}
        ...
        <div className="relative z-10 flex flex-col gap-4 md:gap-6 md:flex-row md:items-center md:justify-between">
          <div className="max-w-xl">
            <h2 id="filters-heading" className="text-2xl font-semibold text-purple-100">{headings.filtersTitle}</h2>
          </div>
          <input
            value={searchValue}
      ...
      <section aria-labelledby="gallery-heading">
        <div className="mb-6 text-left">
          <h2 id="gallery-heading" className="text-2xl font-semibold text-cyan-100">{headings.galleryTitle}</h2>
        </div>
      {filtered.length === 0 ? (
